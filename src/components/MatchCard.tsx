...
export function TBDMatchCard({ label, homeLabel, awayLabel }: { label: string; homeLabel: string; awayLabel: string }) {
  return (
    <div
      className="sticker-card"
      style={{
    ...
    >
      <span className="serial-number">{label}</span>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{ flex: 1, fontSize: 13, fontWeight: 600, color: 'rgba(27,26,20,0.5)' }}>
        ...
        <div style={{ flex: 1, textAlign: 'right', fontSize: 13, fontWeight: 600, color: 'rgba(27,26,20,0.5)' }}>
