...
const en: Translations = {
  ...
  tagline: '"All Eyes on the Beautiful Game" — A Daily Forecast of the 2026 World Cup',
...
const de: Translations = {
  ...
  tagline: '„Alle Augen auf das schöne Spiel" — Ein täglicher WM-Forecast 2026',
...
const es: Translations = {
  ...
  tagline: '"Todos los Ojos en el Bello Juego" — Un Pronóstico Diario del Mundial 2026',
